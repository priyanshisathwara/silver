...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white shadow-md z-50">
      <div className='hidden lg:flex gap-4 justify-end gap-4 text-white bg-blue-600' style={{ paddingTop:'5px', paddingBottom:'5px', paddingRight: '20px' }}>
        ...
        <div> <a className='flex gap-1'> <Phone className='' />+91 80009-85055</a></div>
      </div>
